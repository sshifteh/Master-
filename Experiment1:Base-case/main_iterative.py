...
def iterative(K, i):
	...
	tau_xy_proj = project(tau_xy_, dg1) # nei det naturlige er dg1 fordi de er kontinuerlig innen et element, men ikke over ulike elementer 
	plot(tau_xy_proj, interactive = viz, title = 'shear stress, tau_xy_proj i main')
	#FIXME rename	
	#File('skjaer_baseCase_iteration={}.xdmf'.format(i)) << tau_xy_proj
	...
	plot(Dirac_delta_proj, interactive = viz, title = 'dirac delta  ' )

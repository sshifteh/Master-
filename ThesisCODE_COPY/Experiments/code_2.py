...
from stokes_solver_square import stokes_solver
...
def dg1_line_plot(function, resolution=1000):
	x = numpy.linspace(0, 1, resolution)      # Needs to be changed if the geometry changes
...
def time_stepping(K, time):
	...
	File('code2_shear_c105_n{}_t{}_s{}_e{}_alg{}.xdmf'.format(N, time, speed, epsilon, alg)) << tau_xy_proj

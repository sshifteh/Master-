...
speed = 0.5         # factor multiplied with the Poiseuille flow to alternatie the speed  
h = 1./N            # the mesh size  
...
alg = 'N'           # algorithm o = old; n = new; t = tuned
...
#File('K_n{}_s{}_e{}_alg{}.xdmf'.format(N, speed, epsilon, alg)) << K
...
def time_stepping(K, time):
	...
	#File('u_n{}_t{}_s{}_e{}_alg{}.xdmf'.format( N, time, speed, epsilon, alg)) << u
	...
	File('shear_n{}_t{}_s{}_e{}_alg{}.xdmf'.format(N, time, speed, epsilon, alg)) << tau_xy_proj
	...
	#File('Indicator_n{}_t{}_s{}__e{}_alg{}.xdmf'.format(N, time, speed,epsilon,alg)) << interface_proj 
	...
	#File('Knew_n{}_t{}_s{}_e{}_alg{}.xdmf'.format(N, time, speed, epsilon, alg)) << K_new  
